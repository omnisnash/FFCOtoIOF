package me.omnisnash.ffcotomeos.parser.OE.item;

public class AOEItem
{
    public AOEItem()
    {
    }

    protected String competitorSi;
    protected String competitorId;
    protected String competitorFirstName;
    protected String competitorLastName;
    protected String competitorBirthYear;
    protected String competitorSex;
    protected String clubId;
    protected String clubName;
    protected String clubCity;
    protected String competitorCountry;
    protected String competitorClassId;
    protected String competitorSmallClass;
    protected String competitorLongClass;
    protected String competitorNum1;
    protected String competitorNum2;
    protected String competitorNum3;
    protected String competitorStreet;
    protected String competitorStreetExtra;
    protected String competitorPostalCode;
    protected String competitorCity;
    protected String competitorPhone;
    protected String competitorFax;
    protected String competitorEmail;
    protected String competitorRent;
