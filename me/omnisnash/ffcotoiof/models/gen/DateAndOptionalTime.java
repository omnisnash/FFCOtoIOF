...
/**
 * 
 *                 Defines a point in time which either is known by date and time, or just by date. May be used for event
 *                 dates, when the event date is decided before the time of the first start.
 *             
 * 
