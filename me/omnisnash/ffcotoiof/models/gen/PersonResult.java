...
/**
 * 
 *                 Result information for an individual competitor, including e.g. result status, place, finish time, and
 *                 split times.
 *             
 * 
 * <p>Classe Java pour PersonResult complex type.
 * 
...
public class PersonResult {
    ...
    public List<PersonRaceResult> getResult() {
        if (result == null) {
            result = new ArrayList<PersonRaceResult>();
        }
        return this.result;
    }
