...
public enum RaceClassStatus {
    ...
    /**
     * 
     *                         The class is not organised in this race, e.g. for classes that are organised in only some of the
     *                         races in a multi-race event.
     *                     
     * 
     */
    ...
    /**
     * 
     *                         The results are considered invalid due to technical issues such as misplaced controls. Entry
